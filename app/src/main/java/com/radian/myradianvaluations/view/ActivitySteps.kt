...
class ActivitySteps : AppCompatActivity(), View.OnClickListener, SearchView.OnQueryTextListener {
    ...
    private fun addListItems() {
        ...
        listCategories.add(Categories("Living Room", null))
        listCategories.add(Categories("Bed Room", null))
        listCategories.add(Categories("Bath Room", null))
        listCategories.add(Categories("Terrace Room", null))
        listCategories.add(Categories("Living Room", null))
        listCategories.add(Categories("Bed Room", null))
        listCategories.add(Categories("Bath Room", null))
        listCategories.add(Categories("Terrace Room", null))
